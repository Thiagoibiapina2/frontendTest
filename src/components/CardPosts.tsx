...
export default function CardPosts() {
  ...
  return (
    <div className="flex flex-wrap mt-8">
      {isLoading && <p className="w-full text-center justify-center">Carregando...</p>}
      {!isLoading && Posts.length === 0 && <p className="w-full text-center justify-center">Não há posts criados!</p>}
      {Posts.map((post) => (
